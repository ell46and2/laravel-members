            ...
            <div class="panel__pre-header-primary">
                <form class="filter-bar" action="" method="GET">
                    ...
                    <div class="filter-bar__actions">
                        <a href="{{ route('jockey.activity-log') }}" class="[ filter-bar__filter-button ] [ button button--text-light ]">Reset</a>
                        ...
                        @foreach($events as $event)
                            <tr>
                                ...
                                <td aria-label="Comments">
                                    @if(optional($event->commentsForOrFromJockey)->count())
                                        <div class="icon-notify">
                                            @svg('conversation', 'icon')
                                            <div class="icon-notify__badges">
                                                <span class="[ icon-notify__badge ] [ badge badge-pill badge-dark ]">{{ $event->commentsForOrFromJockey->count() }}</span>
