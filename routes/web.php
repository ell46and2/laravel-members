...
Route::group(['middleware' => ['auth']], function() {
	...
	Route::group(['middleware' => ['role:coach,admin']], function() {
		// Invoice
	...
	// JETS CRM
	Route::get('/jets/crm', 'Jet\CrmController@index')->name('jets.crm.index');
	Route::get('/jets/crm/{crmRecord}', 'Jet\CrmController@show')->name('jets.crm.show');
	Route::get('/jets/crm/{crmRecord}/edit', 'Jet\CrmController@edit')->name('jets.crm.edit');
	Route::post('/jets/crm/{crmRecord}/update', 'Jet\CrmController@update')->name('jets.crm.update');
	Route::delete('/jets/crm/{crmRecord}', 'Jet\CrmController@destroy')->name('jets.crm.delete');
	Route::get('/jets/crm/create/{jockey}', 'Jet\CrmController@create')->name('jets.crm.create');
	Route::get('/jets/crm/create/{crmJockey}/crm', 'Jet\CrmController@createWithCrm')->name('jets.crm.create-with-crm');
	Route::post('/jets/crm/create/{jockey}', 'Jet\CrmController@store')->name('jets.crm.store');
	Route::post('/jets/crm/create/{crmJockey}/crm', 'Jet\CrmController@storeWithCrm')->name('jets.crm.store-with-crm');
	Route::get('/jets/crm/jockey/create', 'Jet\CrmJockeyController@jockeyCreate')->name('jets.crm.jockey-create');
	Route::post('/jets/crm/jockey', 'Jet\CrmJockeyController@jockeyStore')->name('jets.crm.jockey-store');
	Route::get('/jets/crm/jockey/{jockey}', 'Jet\CrmJockeyController@jockeyShow')->name('jets.crm.jockey-show');
	Route::get('/jets/crm/crm-jockey/{crmJockey}', 'Jet\CrmJockeyController@crmJockeyShow')->name('jets.crm.crm-jockey-show');


	// Pdp
	Route::group(['middleware' => ['role:jockey,jets,admin']], function() {
		Route::get('/pdp/list', 'Pdp\PdpController@index')->name('pdp.list');
		Route::get('/pdp/{jockey}/list', 'Pdp\PdpController@jockeyIndex')->name('pdp.jockey.list');
	...
	Route::get('/activity/{activity}/edit', 'Activity\ActivityController@edit')->name('activity.edit');
	Route::put('/activity/{activity}/single', 'Activity\ActivityController@singleUpdate')->name('activity-1:1.update');
	Route::put('/activity/{activity}/group', 'Activity\ActivityController@groupUpdate')->name('activity-group.update');
	...
	Route::get('/admin/activity/log', 'Admin\ActivityController@index')->name('admin.activity-log');
	...
	*/
	...
	Route::group(['middleware' => ['role:admin,coach,jockey']], function() {
	...
	Route::group(['middleware' => ['role:admin']], function() {
		...
		Route::get('/admin/documents/{document}/edit', 'Admin\DocumentController@edit')->name('admin.document.edit');
		Route::post('/admin/documents/{document}', 'Admin\DocumentController@update')->name('admin.document.update');
